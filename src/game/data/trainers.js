...
export const TRAINers = {
  youngster_tim: {
    id: 'youngster_tim',
    name: 'Youngster Tim',
    dialogueBefore: "My Forest cat is top tier! Let's battle!",
    ...
    party: [
      { creatureId: 'LEAFKIT', level: 4 }
    ]
  },
  hiker_bob: {
    id: 'hiker_bob',
    name: 'Hiker Bob',
    dialogueBefore: "The path gets dangerous from here. Show me what you've got!",
