...
export const ASSETS = {
  ...
  CREATURES: {
    ABYSSINIAN: { KEY: 'creature_abyssinian', PATH: '/assets/sprites/creatures/ABYSSINIAN.png' },
    AETHERION: { KEY: 'creature_aetherion', PATH: '/assets/sprites/creatures/AETHERION.png' },
    AMERICAN_SHORTHAIR: { KEY: 'creature_american_shorthair', PATH: '/assets/sprites/creatures/AMERICAN_SHORTHAIR.png' },
    AQUARION: { KEY: 'creature_aquarion', PATH: '/assets/sprites/creatures/AQUARION.png' },
    ARCANEFANG: { KEY: 'creature_arcanefang', PATH: '/assets/sprites/creatures/ARCANEFANG.png' },
    ASHLYNX: { KEY: 'creature_ashlynx', PATH: '/assets/sprites/creatures/ASHLYNX.png' },
    AURORACAT: { KEY: 'creature_auroracat', PATH: '/assets/sprites/creatures/AURORACAT.png' },
    BARKPELT: { KEY: 'creature_barkpelt', PATH: '/assets/sprites/creatures/BARKPELT.png' },
    BENGAL: { KEY: 'creature_bengal', PATH: '/assets/sprites/creatures/BENGAL.png' },
    BIRMAN: { KEY: 'creature_birman', PATH: '/assets/sprites/creatures/BIRMAN.png' },
    BLAZECLAW: { KEY: 'creature_blazeclaw', PATH: '/assets/sprites/creatures/BLAZECLAW.png' },
    BLIZZARDFANG: { KEY: 'creature_blizzardfang', PATH: '/assets/sprites/creatures/BLIZZARDFANG.png' },
    BOULDERLYNX: { KEY: 'creature_boulderlynx', PATH: '/assets/sprites/creatures/BOULDERLYNX.png' },
    BRAMBLECAT: { KEY: 'creature_bramblecat', PATH: '/assets/sprites/creatures/BRAMBLECAT.png' },
    BRITISH_SHORTHAIR: { KEY: 'creature_british_shorthair', PATH: '/assets/sprites/creatures/BRITISH_SHORTHAIR.png' },
    BURMILLA: { KEY: 'creature_burmilla', PATH: '/assets/sprites/creatures/BURMILLA.png' },
    CELESTIPELT: { KEY: 'creature_celestipelt', PATH: '/assets/sprites/creatures/CELESTIPELT.png' },
    CHARTREUX: { KEY: 'creature_chartreux', PATH: '/assets/sprites/creatures/CHARTREUX.png' },
    CINDERCAT: { KEY: 'creature_cindercat', PATH: '/assets/sprites/creatures/CINDERCAT.png' },
    CINDERCLAW: { KEY: 'creature_cinderclaw', PATH: '/assets/sprites/creatures/CINDERCLAW.png' },
    CLIFFMAW: { KEY: 'creature_cliffmaw', PATH: '/assets/sprites/creatures/CLIFFMAW.png' },
    CORNISH_REX: { KEY: 'creature_cornish_rex', PATH: '/assets/sprites/creatures/CORNISH_REX.png' },
    DEVON_REX: { KEY: 'creature_devon_rex', PATH: '/assets/sprites/creatures/DEVON_REX.png' },
    DEWKIT: { KEY: 'creature_dewkit', PATH: '/assets/sprites/creatures/DEWKIT.png' },
    DEWTAIL: { KEY: 'creature_dewtail', PATH: '/assets/sprites/creatures/DEWTAIL.png' },
    DUSKPAW: { KEY: 'creature_duskpaw', PATH: '/assets/sprites/creatures/DUSKPAW.png' },
    EGYPTIAN_MAU: { KEY: 'creature_egyptian_mau', PATH: '/assets/sprites/creatures/EGYPTIAN_MAU.png' },
    EMBERLYNX: { KEY: 'creature_emberlynx', PATH: '/assets/sprites/creatures/EMBERLYNX.png' },
    EMBERPAW: { KEY: 'creature_emberpaw', PATH: '/assets/sprites/creatures/EMBERPAW.png' },
    FERNCLAW: { KEY: 'creature_fernclaw', PATH: '/assets/sprites/creatures/FERNCLAW.png' },
    FLOODLYNX: { KEY: 'creature_floodlynx', PATH: '/assets/sprites/creatures/FLOODLYNX.png' },
    FOREST_SPHYNX: { KEY: 'creature_forest_sphynx', PATH: '/assets/sprites/creatures/FOREST_SPHYNX.png' },
    FROSTKIT: { KEY: 'creature_frostkit', PATH: '/assets/sprites/creatures/FROSTKIT.png' },
    GALECLAW: { KEY: 'creature_galeclaw', PATH: '/assets/sprites/creatures/GALECLAW.png' },
    GLACIARA: { KEY: 'creature_glaciara', PATH: '/assets/sprites/creatures/GLACIARA.png' },
    GLACIERPAW: { KEY: 'creature_glacierpaw', PATH: '/assets/sprites/creatures/GLACIERPAW.png' },
    GRANITECAT: { KEY: 'creature_granitecat', PATH: '/assets/sprites/creatures/GRANITECAT.png' },
    HAVANA_BROWN: { KEY: 'creature_havana_brown', PATH: '/assets/sprites/creatures/HAVANA_BROWN.png' },
    INFERMANE: { KEY: 'creature_infermane', PATH: '/assets/sprites/creatures/INFERMANE.png' },
    IRONBARK: { KEY: 'creature_ironbark', PATH: '/assets/sprites/creatures/IRONBARK.png' },
    LEAFKIT: { KEY: 'creature_leafkit', PATH: '/assets/sprites/creatures/LEAFTKIT.png' },
    LUMINA: { KEY: 'creature_lumina', PATH: '/assets/sprites/creatures/LUMINA.png' },
    MAINE_COON: { KEY: 'creature_maine_coon', PATH: '/assets/sprites/creatures/MAINE_COON.png' },
    MANX: { KEY: 'creature_manx', PATH: '/assets/sprites/creatures/MANX.png' },
    MISTLYNX: { KEY: 'creature_mistlynx', PATH: '/assets/sprites/creatures/MISTLYNX.png' },
    MISTTAIL: { KEY: 'creature_misttail', PATH: '/assets/sprites/creatures/MISTTAIL.png' },
    MOSSLYNX: { KEY: 'creature_mosslynx', PATH: '/assets/sprites/creatures/MOSSLYNX.png' },
    MUNCHKIN: { KEY: 'creature_munchkin', PATH: '/assets/sprites/creatures/MUNCHKIN.png' },
    NEBELUNG: { KEY: 'creature_nebelung', PATH: '/assets/sprites/creatures/NEBELUNG.png' },
    NIGHTKIT: { KEY: 'creature_nightkit', PATH: '/assets/sprites/creatures/NIGHTKIT.png' },
    NIGHTPELT: { KEY: 'creature_nightpelt', PATH: '/assets/sprites/creatures/NIGHTPELT.png' },
    NOCTYRA: { KEY: 'creature_noctyra', PATH: '/assets/sprites/creatures/NOCTYRA.png' },
    NORWEGIAN_FOREST: { KEY: 'creature_norwegian_forest', PATH: '/assets/sprites/creatures/NORWEGIAN_FOREST.png' },
    ORIENTAL_SHORTHAIR: { KEY: 'creature_oriental_shorthair', PATH: '/assets/sprites/creatures/ORIENTAL_SHORTHAIR.png' },
    PEBBLEPAW: { KEY: 'creature_pebblepaw', PATH: '/assets/sprites/creatures/PEBBLEPAW.png' },
    PERSIAN: { KEY: 'creature_persian', PATH: '/assets/sprites/creatures/PERSIAN.png' },
    PHANTOMLYNX: { KEY: 'creature_phantomlynx', PATH: '/assets/sprites/creatures/PHANTOMLYNX.png' },
    PYROLYNX: { KEY: 'creature_pyrolynx', PATH: '/assets/sprites/creatures/PYROLTNX.png' },
    RAGAMUFFIN: { KEY: 'creature_ragamuffin', PATH: '/assets/sprites/creatures/RAGAMUFFIN.png' },
    RAGDOLL: { KEY: 'creature_ragdoll', PATH: '/assets/sprites/creatures/RAGDOLL.png' },
    RIPPLEPAW: { KEY: 'creature_ripplepaw', PATH: '/assets/sprites/creatures/RIPPLEPAW.png' },
    RUNECLAW: { KEY: 'creature_runeclaw', PATH: '/assets/sprites/creatures/RUNECLAW.png' },
    RUSSIAN_BLUE: { KEY: 'creature_russian_blue', PATH: '/assets/sprites/creatures/RUSSIAN_BLUE.png' },
    SAVANNAH: { KEY: 'creature_savannah', PATH: '/assets/sprites/creatures/SAVANNAH.png' },
    SCOTTISH_FOLD: { KEY: 'creature_scottish_fold', PATH: '/assets/sprites/creatures/SCOTTISH_FOLD.png' },
    SELKIRK_REX: { KEY: 'creature_selkirk_rex', PATH: '/assets/sprites/creatures/SELKIRK_REX.png' },
    SHADECLAW: { KEY: 'creature_shadeclaw', PATH: '/assets/sprites/creatures/SHADECLAW.png' },
    SIAMESE: { KEY: 'creature_siamese', PATH: '/assets/sprites/creatures/SIAMESE.png' },
    SINGAPURA: { KEY: 'creature_singapura', PATH: '/assets/sprites/creatures/SINGAPURA.png' },
    SNAGPUSS: { KEY: 'creature_snagpuss', PATH: '/assets/sprites/creatures/SNAGPUSS.png' },
    SNOWPELT: { KEY: 'creature_snowpelt', PATH: '/assets/sprites/creatures/SNOWPELT.png' },
    SOLARION: { KEY: 'creature_solarion', PATH: '/assets/sprites/creatures/SOLARION.png' },
    SOMALI: { KEY: 'creature_somali', PATH: '/assets/sprites/creatures/SOMALI.png' },
    SOULPELT: { KEY: 'creature_soulpelt', PATH: '/assets/sprites/creatures/SOULPELT.png' },
    SPARKPAW: { KEY: 'creature_sparkpaw', PATH: '/assets/sprites/creatures/SPARKPAIN.png' },
    SPECTRALCLAW: { KEY: 'creature_spectralclaw', PATH: '/assets/sprites/creatures/SPECTRALCLAW.png' },
    STARLIGHTKIT: { KEY: 'creature_starlightkit', PATH: '/assets/sprites/creatures/STARLIGHTKIT.png' },
    STONECLAW: { KEY: 'creature_stoneclaw', PATH: '/assets/sprites/creatures/STONECLAW.png' },
    STORMKIT: { KEY: 'creature_stormkit', PATH: '/assets/sprites/creatures/STORMKIT.png' },
    STREAMTAIL: { KEY: 'creature_streamtail', PATH: '/assets/sprites/creatures/STREAMTAIL.png' },
    TEMPESTCLAW: { KEY: 'creature_tempestclaw', PATH: '/assets/sprites/creatures/TEMPESTCLAW.png' },
    TEMPESTFANG: { KEY: 'creature_tempestfang', PATH: '/assets/sprites/creatures/TEMPESTFANG.png' },
    TERRACLAW: { KEY: 'creature_terraclaw', PATH: '/assets/sprites/creatures/TERRACLAW.png' },
    THISTLEFUR: { KEY: 'creature_thistlefur', PATH: '/assets/sprites/creatures/THISTLEFUR.png' },
    THISTLEKIT: { KEY: 'creature_thistlekit', PATH: '/assets/sprites/creatures/THISTLEKIT.png' },
    THORNKIT: { KEY: 'creature_thornkit', PATH: '/assets/sprites/creatures/THORNKIT.png' },
    THORNMANE: { KEY: 'creature_thornmane', PATH: '/assets/sprites/creatures/THORNMANE.png' },
    THORNPROWLER: { KEY: 'creature_thornprowler', PATH: '/assets/sprites/creatures/THORNPROWLER.png' },
    THUNDERLYNX: { KEY: 'creature_thunderlynx', PATH: '/assets/sprites/creatures/THUNDERLYNX.png' },
    TIDALCLAW: { KEY: 'creature_tidalclaw', PATH: '/assets/sprites/creatures/TIDALCLAW.png' },
    TITANPELT: { KEY: 'creature_titanpelt', PATH: '/assets/sprites/creatures/TITANPELT.png' },
    TOYGER: { KEY: 'creature_toyger', PATH: '/assets/sprites/creatures/TOYGER.png' },
    TURKISH_ANGORA: { KEY: 'creature_turkish_angora', PATH: '/assets/sprites/creatures/TURKISH_ANGORA.png' },
    TURKISH_VAN: { KEY: 'creature_turkish_van', PATH: '/assets/sprites/creatures/TURKISH_VAN.png' },
    UMBRAFANG: { KEY: 'creature_umbrafang', PATH: '/assets/sprites/creatures/UMBRAFANG.png' },
    VERDANTCLAW: { KEY: 'creature_verdantclaw', PATH: '/assets/sprites/creatures/VERDANTCLAW.png' },
    VERDANTLYNX: { KEY: 'creature_verdantlynx', PATH: '/assets/sprites/creatures/VERDANTLYNX.png' },
